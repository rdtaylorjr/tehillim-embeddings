...
from morphological.atomic import FeatureKey, atomic_psalm_vectors, atomic_vectors
...
DENSE_BUILDERS = {
    "inventory": morph_signature_vectors,
    "inventory_psalm": morph_signature_psalm_vectors,
