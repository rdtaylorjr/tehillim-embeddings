...
def generate(psalms: list[MorphologicalPsalm], output_root: Path) -> list[str]:
    ...
    for feature in _FEATURES:
        ...
        for construction, builder in (
            ...
            print(
                f"computing morphological feature={unit} construction={construction}...",
                file=sys.stderr,
            )
    ...
    print("computing morphological feature=morph_full construction=all...", file=sys.stderr)
    if _write_if_missing(
        output_root,
        "morph_full",
        "all",
    ...
    print("computing morphological feature=morph_full construction=all_psalm...", file=sys.stderr)
    if _write_if_missing(
        output_root,
        "morph_full",
        "all_psalm",
