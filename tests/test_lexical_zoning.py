...
class TestPositionalCentroidVectors:
    ...
    def test_inventory_half_is_icf_weight_if_present_anywhere_in_the_psalm(self):
        ...
        # A appears in every colon, B in one colon, C absent.
        psalms = [
            _psalm(
                number=1,
                lexemes=(("A",), ("A", "B"), ("A",)),
        ...
        b = vectors[100][:3]
        # union indicator, not fraction-of-colons: A present anywhere -> full ICF weight.
    ...
    def test_inventory_half_is_invariant_under_shuffled_order_but_position_half_is_not(self):
        ...
        shuffled = positional_centroid_vectors(
            ...
            order_by_psalm={1: np.array([3, 1, 2, 0])},  # moves A's content to position 3
        )

        assert natural[100][0] == shuffled[100][0]  # b: invariant
        assert natural[100][1] != shuffled[100][1]  # m: not invariant
