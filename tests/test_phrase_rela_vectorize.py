...
from phrase.rela_vectorize import (
...
def _psalm(*, number, rela_by_colon, nodes=None):
    ...
    return PhrasePsalm(number=number, half_verse_nodes=nodes, half_verse_rela=rela_by_colon)
...
class TestPhraseRela1gramVectors:
    def test_has_dimension_of_the_safe_vocabulary(self):
        psalms = [_psalm(number=1, rela_by_colon=(("NA", "Appo"),))]
    ...
    def test_keys_vectors_by_colon_node_id(self):
        psalms = [_psalm(number=1, rela_by_colon=(("NA",), ("Appo",)), nodes=(200, 201))]
        vectors = phrase_rela_1gram_vectors(psalms)
...
class TestPhraseRela1gramPsalmVectors:
    def test_broadcasts_the_identical_vector_to_every_colon_node(self):
        psalms = [_psalm(number=1, rela_by_colon=(("NA",), ("Appo",)), nodes=(400, 401))]
    ...
    def test_masks_para_before_pooling_across_colons(self):
        psalms = [_psalm(number=1, rela_by_colon=(("Para",), ("Appo",)), nodes=(500, 501))]
