...
class TestGenerateShuffleControl:
    def test_writes_n_seeded_datasets(self, tmp_path):
        ...
        assert written == [
            "icf_posmean_psalm_shuffle01",
            "icf_posmean_psalm_shuffle02",
            "icf_posmean_psalm_shuffle03",
        ]
    ...
    def test_each_shuffle_broadcasts_the_same_vector_to_every_colon(self, tmp_path):
        ...
        table = pq.read_table(dataset_path(tmp_path, "lex0", "icf_posmean_psalm_shuffle01"))
    ...
    def test_different_seeds_give_different_vectors(self, tmp_path):
        ...
        table1 = pq.read_table(dataset_path(tmp_path, "lex0", "icf_posmean_psalm_shuffle01"))
        table2 = pq.read_table(dataset_path(tmp_path, "lex0", "icf_posmean_psalm_shuffle02"))
