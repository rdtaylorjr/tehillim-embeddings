...
def _psalm(*, number, phrase_rela_by_colon, nodes=None):
    ...
    return PhrasePsalm(number=number, colon_nodes=nodes, colon_subphrase_rela=phrase_rela_by_colon)
...
class TestSubphraseRela1gramVectors:
    def test_has_dimension_of_the_safe_vocabulary(self):
        psalms = [_psalm(number=1, phrase_rela_by_colon=(("NA", "rec"),))]
    ...
    def test_keys_vectors_by_colon_node_id(self):
        psalms = [_psalm(number=1, phrase_rela_by_colon=(("NA",), ("rec",)), nodes=(200, 201))]
        vectors = subphrase_rela_1gram_vectors(psalms)
...
class TestSubphraseRela1gramPsalmVectors:
    def test_broadcasts_the_identical_vector_to_every_colon_node(self):
        psalms = [_psalm(number=1, phrase_rela_by_colon=(("NA",), ("rec",)), nodes=(400, 401))]
    ...
    def test_masks_par_before_pooling_across_colons(self):
        psalms = [_psalm(number=1, phrase_rela_by_colon=(("par",), ("rec",)), nodes=(500, 501))]
