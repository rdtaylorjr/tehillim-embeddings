...
from syntactic.scripts.compute_full_signature_support import build_external_full_signature_counts
...
def _fake_two_book_api() -> _FakeApi:
    ...
    function = _FakeFeature({100: "Subj", 200: "Subj", 201: "Subj"})
    det = _FakeFeature({10: "NA", 20: "NA", 21: "NA", 22: "det"})
    L = _FakeL(  # noqa: N806
        atoms_by_book={1: [10], 2: [20, 21, 22]},
        mother_by_atom={10: 100, 20: 200, 21: 200, 22: 201},
    )
    return _FakeApi(_FakeF(otype, book, typ, function, det), L)


class TestBuildExternalFullSignatureCounts:
