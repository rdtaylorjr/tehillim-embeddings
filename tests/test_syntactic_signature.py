...
from syntactic.signature import (
    build_full_phrase_signature,
    build_phrase_signature,
    half_verse_full_signatures,
    half_verse_signatures,
...
class TestBuildPhraseSignature:
    def test_joins_typ_and_function_with_a_half_verse(self):
...
class TestHalfVerseSignatures:
    def test_builds_one_signature_per_atom_aligned_across_both_features(self):
        signatures = half_verse_signatures(
            typ=("NP", "VP", "PP"), function=("Subj", "Pred", "Cmpl")
        )
