...
from syntactic.complexity import (
    half_verse_complexity_features,
...
class TestHalfVerseComplexityFeatures:
    def test_is_all_zero_for_an_empty_half_verse(self):
        features = half_verse_complexity_features((), (), ())
    ...
    def test_counts_atoms_and_distinct_phrases(self):
        ...
        features = half_verse_complexity_features((2, 3), (900, 900), (2, 2))
        assert features[0] == 2
        assert features[1] == 1

    def test_mean_words_per_atom(self):
        features = half_verse_complexity_features((2, 4), (900, 901), (1, 1))
    ...
    def test_proportion_multi_atom_phrases(self):
        ...
        features = half_verse_complexity_features((2, 3, 1), (900, 900, 901), (2, 2, 1))
        assert np.isclose(features[3], 0.5)

    def test_a_half_verse_with_only_single_atom_phrases_has_zero_proportion_multi_atom(self):
        features = half_verse_complexity_features((2, 3), (900, 901), (1, 1))
...
class TestPhraseComplexityPsalmVectors:
    def test_broadcasts_the_unweighted_mean_across_half_verses(self):
        psalms = [
            _psalm(
                number=1,
                nodes=(100, 101),
        ...
        # half-verse 100: n_atoms=2; half-verse 101: n_atoms=1. Mean = 1.5.
