...
from morphology.deploy import psalm_deploy_vectors, suffix_deploy_vectors
from morphology.suffix import NONE_SUFFIX_TOKEN, SUFFIX_VOCABULARY
...
class TestSuffixDeployVectors:
    ...
    def test_none_suffix_present_in_every_half_verse_of_a_suffixless_psalm(self):
        psalm = _psalm(
            number=1,
            nodes=(100, 101),
            prs_gn=(("NA",), ("NA",)),
