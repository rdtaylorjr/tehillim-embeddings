...
from syntactic.scripts.generate_deploy_shuffle_control import generate_shuffle_control
...
class TestGenerateShuffleControl:
    def test_writes_n_seeded_datasets(self, tmp_path):
        ...
        assert written == [
            "signature_posmean_shuffle0001",
            "signature_posmean_shuffle0002",
            "signature_posmean_shuffle0003",
        ]
    ...
    def test_each_shuffle_broadcasts_the_same_vector_to_every_half_verse(self, tmp_path):
        ...
        table = pq.read_table(dataset_path(tmp_path, "signature", "posmean_shuffle0001"))
    ...
    def test_different_seeds_give_different_vectors(self, tmp_path):
        ...
        table1 = pq.read_table(dataset_path(tmp_path, "signature", "posmean_shuffle0001"))
        table2 = pq.read_table(dataset_path(tmp_path, "signature", "posmean_shuffle0002"))
